...
public class SamAlignmentBuilder_Test {
  ...
  public void testPairedRead() {
    ...
    SequenceBuilder mate1 = new SequenceBuilder().setName("query").asAlignment("ref", 0, null, false, 0, 0, false, false, position2s);
    SequenceBuilder mate2 = new SequenceBuilder().setName("query").asAlignment("ref", 0, null, true, 0, 0, false, false, position1s);

    SequenceBuilder wrongQuery = new SequenceBuilder().setName("otherQuery").asAlignment("ref", 0, null, true, 0, 0, false, false, position1s);
  ...
  public void testUnpairedSupplementaryAlignments() {
    ...
    SequenceBuilder component1 = new SequenceBuilder().setName("query").asAlignment("ref", 0, null, false, 0, 0, false, false, position2s);
    SequenceBuilder component2 = new SequenceBuilder().setName("query").asAlignment("ref", 100, null, false, 0, 0, false, false, position1s);
  ...
  public void testMultipleSupplementaryAlignments() {
    ...
    SequenceBuilder component1 = new SequenceBuilder().setName("query").asAlignment("ref", 0, null, false, 0, 0, false, false, position1Others);
    SequenceBuilder component2 = new SequenceBuilder().setName("query").asAlignment("ref", 50, null, false, 0, 0, false, false, position2Others);
    SequenceBuilder component3 = new SequenceBuilder().setName("query").asAlignment("ref", 100, null, false, 0, 0, false, false, position3Others);
  ...
  public void testPairedSupplementaryAlignments() {
    ...
    SequenceBuilder mate1 = new SequenceBuilder().setName("query").asAlignment("ref", 0, null, false, 0, 0, false, false, mate1Others);
    SequenceBuilder mate2Component1 = new SequenceBuilder().setName("query").asAlignment("ref", 100, null, true, 0, 0, false, false, mate2Component1Others);
    SequenceBuilder mate2Component2 = new SequenceBuilder().setName("query").asAlignment("ref", 150, null, true, 0, 0, false, false, mate2Component2Others);
  ...
  public void testPairedSupplementaryAlignmentsSamePosition() {
    ...
    SequenceBuilder mate1Component1 = new SequenceBuilder().setName("query").asAlignment("ref", 0, null, false, 0, 0, false, false, mate1Component1Others);
    SequenceBuilder mate1Component2 = new SequenceBuilder().setName("query").asAlignment("ref", 150, null, false, 0, 0, false, false, mate1Component2Others);
    SequenceBuilder mate2Component1 = new SequenceBuilder().setName("query").asAlignment("ref", 100, null, true, 0, 0, false, false, mate2Component1Others);
    SequenceBuilder mate2Component2 = new SequenceBuilder().setName("query").asAlignment("ref", 150, null, true, 0, 0, false, false, mate2Component2Others);
